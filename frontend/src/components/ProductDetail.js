...
export default function ProductDetail() {
    ...
    const { loading, isReviewSubmitted, error } = useSelector((state) => state.productState);
    const { id } = useParams();
                ...
                <Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" disabled={product.stock == 0 ? true : false} onClick={() =>{ dispatch(addCartItem(product._id, quantity))
                            ...
                            <p>Status: <span className={product.stock > 0 ? 'greenColor' : 'redColor'} id="stock_status">{product.stock > 0 ? 'In Stock' : 'Stock Out'}</span></p>
