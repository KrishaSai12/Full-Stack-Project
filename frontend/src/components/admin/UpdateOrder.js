...
import { updateOrder, orderDetail as orderDetailActions } from "../../actions/orderActions";
...
export default function UpdateOrder() {
    ...
    const { user = {}, shippingInfo={}, orderItems = [],  totalPrice = 0 } = orderDetail;
                ...
                <Fragment>
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-3 mt-5">
                            ...
                            <button onClick={submitHandler}  disabled={loading} className=" btn btn-primary btn-block ">
